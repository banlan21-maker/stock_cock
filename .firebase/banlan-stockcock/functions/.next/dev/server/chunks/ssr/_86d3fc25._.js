...
function PolicyPage() {
    ...
    const load = ()=>{
        setLoading(true);
        setError("");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchPolicyList"])().then(setData).catch((e)=>setError(e.message)).finally(()=>setLoading(false));
    };
...
//# sourceMappingURL=_86d3fc25._.js.map