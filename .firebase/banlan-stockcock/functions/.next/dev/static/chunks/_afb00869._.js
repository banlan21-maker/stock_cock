...
function AdProvider({ children }) {
    ...
    const [onCloseCallback, setOnCloseCallback] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const requestInterstitial = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdProvider.useCallback[requestInterstitial]": (onClose)=>{
            setShowInterstitial(true);
            if (onClose) setOnCloseCallback({
                "AdProvider.useCallback[requestInterstitial]": ()=>onClose
            }["AdProvider.useCallback[requestInterstitial]"]);
...
_s(AdProvider, "8uPhLhyHK1EPxn7tEYijb0obHcM=", false, function() {
    return [
...
"[project]/context/RewardProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const RewardContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function RewardProvider({ children }) {
    _s();
    const [activeRequest, setActiveRequest] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const requestReward = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RewardProvider.useCallback[requestReward]": (onEarned)=>{
            setActiveRequest({
                onEarned
            });
        }
    }["RewardProvider.useCallback[requestReward]"], []);
    const handleEarned = ()=>{
        if (activeRequest) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RewardContext.Provider, {
        value: {
            requestReward
        },
        children: [
            children,
            activeRequest && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RewardAdModal, {
                onEarned: handleEarned,
                onClose: handleClose
            }, void 0, false, {
                fileName: "[project]/context/RewardProvider.tsx",
                lineNumber: 33,
                columnNumber: 17
            }, this)
        ]
...
_s(RewardProvider, "D23fDN1duAodckQzf/+R2+h+cmk=");
_c = RewardProvider;
function useReward() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(RewardContext);
    if (context === undefined) {
        throw new Error("useReward must be used within a RewardProvider");
    }
    return context;
}
_s1(useReward, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
function RewardAdModal({ onEarned, onClose }) {
    _s2();
    const [seconds, setSeconds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(5); // 보상형 광고 시뮬레이션: 5초 (원래 30초지만 테스트용으로 5초)
    const [isAdEnded, setIsAdEnded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "RewardAdModal.useEffect": ()=>{
            if (seconds <= 0) {
                setIsAdEnded(true);
                return;
            }
            const timer = setInterval({
                "RewardAdModal.useEffect.timer": ()=>{
                    setSeconds({
                        "RewardAdModal.useEffect.timer": (s)=>s - 1
                    }["RewardAdModal.useEffect.timer"]);
                }
            }["RewardAdModal.useEffect.timer"], 1000);
            return ({
                "RewardAdModal.useEffect": ()=>clearInterval(timer)
            })["RewardAdModal.useEffect"];
        }
    }["RewardAdModal.useEffect"], [
        seconds
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "w-full max-w-md bg-navy-light border border-white/20 rounded-3xl overflow-hidden shadow-2xl flex flex-col p-8 text-center",
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mb-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "inline-block px-3 py-1 bg-amber-500/20 text-amber-500 text-[10px] font-bold rounded-full mb-4",
                            children: "REWARD AD"
                        }, void 0, false, {
                            fileName: "[project]/context/RewardProvider.tsx",
                            lineNumber: 69,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "광고를 시청하면 즉시 꼰대아저씨의 분석 결과를 확인하실 수 있습니다."
                        }, void 0, false, {
                            fileName: "[project]/context/RewardProvider.tsx",
                            lineNumber: 73,
                            columnNumber: 21
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex-1 bg-black/40 rounded-2xl aspect-video flex flex-col items-center justify-center mb-8 border border-white/5 relative overflow-hidden",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        !isAdEnded ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            className: "flex flex-col items-center gap-3 animate-in zoom-in duration-300",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "w-16 h-16 bg-green-500 rounded-full flex items-center justify-center text-3xl",
                                    children: "✓"
                                }, void 0, false, {
                                    fileName: "[project]/context/RewardProvider.tsx",
                                    lineNumber: 92,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            disabled: !isAdEnded,
                            className: `flex-1 py-3 rounded-xl text-sm font-bold transition-all ${isAdEnded ? "bg-blue-600 text-white hover:bg-blue-700 shadow-lg shadow-blue-500/20 active:scale-95" : "bg-gray-700 text-gray-500 cursor-not-allowed"}`,
                            children: isAdEnded ? "분석 결과 보기" : "시청 중..."
                        }, void 0, false, {
                            fileName: "[project]/context/RewardProvider.tsx",
                            lineNumber: 106,
                            columnNumber: 21
...
_s2(RewardAdModal, "2A10hejGG8B9EfcO9svj3ckGz/4=");
_c1 = RewardAdModal;
var _c, _c1;
__turbopack_context__.k.register(_c, "RewardProvider");
__turbopack_context__.k.register(_c1, "RewardAdModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_afb00869._.js.map